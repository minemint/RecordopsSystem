...
CREATE TABLE `district_tbl` (
  ...
  KEY `fk_districtSub` (`subdistrictId`),
  CONSTRAINT `fk_districtSub` FOREIGN KEY (`subdistrictId`) REFERENCES `subdistrict_tbl` (`subdistrictId`)
...
INSERT INTO `district_tbl` VALUES (1,'D',1);
